...
from knowledge_reuse.sources.lean_mathlib.layout import LEAN_ROOT, RESULTS_ROOT, ROOT

RESULT_JSON = RESULTS_ROOT / "capability-probe.json"
RESULT_MD = RESULTS_ROOT / "capability-probe.md"
